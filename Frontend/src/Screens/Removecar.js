    ...
    <div className="bg-image" style={{
      ...
      <div className="container d-flex flex-column justify-content-center align-items-center h-100  bg-opacity-25">
        <div className="card border-0" style={{ 
          ...
          <h6 className="text-center mb-3" style={{ fontSize: '2rem', fontWeight: 'bold', color: 'black' }}>Delete Car</h6>
          <div className="mb-3">
            <label htmlFor="userEmail" className="form-label" style={{ fontWeight: 'bold', color: 'black' }}>Enter Registration Number:</label>
            <input
              type="text"
