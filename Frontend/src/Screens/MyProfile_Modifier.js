      ...
      <div className="d-flex flex-column min-vh-100"> {/* Flex column ensures full height */}
        <div className="container my-5 flex-grow-1" style={{ paddingTop: '80px'}}> {/* Increased margin for spacing */}
          ...
          <form className="row g-3">
            ...
            <div className="col-12 d-flex justify-content-center align-items-center mt-4" style={{paddingTop:'40px', backgroundColor:'#1e526b'}}>
              <button
                type="button"
                className="btn btn-primary me-3" 
                // Added margin-right to separate from Update button
...
export default Myprofile_Modifier;
